...
SECRET_KEY = '^=vtj&z1rw=$8^(i^etdr83%bsxit8v+o74*2w*($lh82$ds#4'
...
EMAIL_HOST_USER = "example@gmail.com" #put your email
EMAIL_HOST = "smtp.gmail.com"
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_PASSWORD = 'PASSWORD' #put your email password
